...
<ul>
    <li class="mb-3">
        <a href="{{route('admin.home')}}"><i class="fa-solid fa-gauge-high me-2"></i> Dashboard</a>
    </li>
    <li class="mb-3">
        <a href="{{route('admin.orders.index')}}"><i class="fa-solid fa-chart-column me-2"></i> Ordini</a>
    </li>
    <li class="mb-3">
